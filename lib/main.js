...
var mPanel = Panel({
	...
	contentScriptFile: [self.data.url('theme/jquery.min.js'),self.data.url('theme/jquery-ui.min.js'),self.data.url('api.js'), self.data.url('main-panel.js')],
...
function showNotification([type,title,icon,name,stats]) {
	...
	let nPanel = Panel({
		...
		contentScriptFile: [self.data.url('theme/jquery.min.js'),self.data.url('theme/jquery-ui.min.js'),self.data.url('notification-panel.js')],
		contentScriptWhen: 'end',
		contentScriptOptions: {
			prefs: sp.prefs,
			type: type,
...
var PM = pageMod.PageMod({
	...
	contentScriptFile: [self.data.url('theme/jquery.min.js'),self.data.url('theme/jquery-ui.min.js'),self.data.url('api.js'), self.data.url('webpage-mod.js')],
	contentScriptOptions: {
		prefs: sp.prefs,
...
console.log('nzbFox loaded on '+system.vendor+' '+system.name+' '+system.version);