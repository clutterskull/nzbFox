...
var SendQueue = [];
const SupportedIndexers = ['*.fanzub.com','*.dognzb.cr','*.nzbs.org','*.pfmonkey.com','*.nmatrix.co.za','*.oznzb.com','*.binsearch.info','*.binsearch.net','*.nzbgeek.info','*.nzb.su','*.nzbplanet.net'];
var CustomIndexers = [];
