...
var SendQueue = [];
const SupportedIndexers = ['*.newz-complex.org','*.animenzb.com','*.dognzb.cr','*.nzbs.org','*.pfmonkey.com','*.nzb.su','*.nzbindex.nl','*.nzbclub.com','*.nmatrix.co.za', '*.althub.co.za','*.oznzb.com','*.binsearch.info','*.binsearch.net','*.nzbgeek.info','*.nzbplanet.net'];
var CustomIndexers = [];
...
if (system.version.split('.')[0] < 38) { // "chrome-mod.js" was broken by FF 38+ - no update available :(
