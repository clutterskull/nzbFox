...
var SendQueue = [];
const SupportedIndexers = ['*.animenzb.com','*.dognzb.cr','*.nzbs.org','*.pfmonkey.com','*.nzb.su','*.nzbindex.nl','*.nzbclub.com','*.nmatrix.co.za', '*.althub.co.za','*.oznzb.com','*.binsearch.info','*.binsearch.net','*.nzbgeek.info','*.nzbplanet.net'];
var CustomIndexers = [];
