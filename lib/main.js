...
var SendQueue = [];
const SupportedIndexers = ['*.fanzub.com','*.dognzb.cr','*.nzbs.org','*.nmatrix.co.za','*.oznzb.com','*.binsearch.info','*.binsearch.net'];
...
//						console.log('CLI = '+SendQueue[i].target);
//						console.log('Path = '+download.target.path);
//						console.log('Title  = '+SendQueue[i].fileName);
...
function onPrefChange(prefName) {
	nzbgRPC.url = 'http://'+sp.prefs.nzbg_ip+':'+sp.prefs.nzbg_port+'/'+encodeURIComponent(sp.prefs.nzbg_user)+':'+encodeURIComponent(sp.prefs.nzbg_pass)+'/jsonrpc';
	sabRPC.url = 'http://'+sp.prefs.sab_ip+':'+sp.prefs.sab_port+'/sabnzbd/api'
...
/*
//////////////////////////////////////// SHOW PANEL ATTACHED TO DOWNLOAD BUTTON
...
getNodeView.define(XULWrapper, wrapper => utils.getMostRecentBrowserWindow().document.querySelector(wrapper.selector));
let downloadsButton = XULWrapper('#downloads-button');

var panel = panels.Panel({
  contentURL: self.data.url('nzbDownload_Panel.html'),
  onHide: function() {
  }
});
panel.show({position: downloadsButton});
//////////////////////////////////////// //////////////////////////////////////// ////////////////////////////////////////
*/