...
//	console.log('rpc-call '+data.target+' '+data.method);
...
function showNotification([target,title,icon,dlName,dlStats]) {
	if (!sp.prefs.dl_notifications) return;
	// Notifications Panel
	let nPanel = Panel({
...
//showNotification(['sab','Download Success','nzb-32-green.png','Test Notification NZB Name','123 MB - Downloaded in # minutes, ## seconds at an average of ### KB/s<br/>Unpacked # files in ## seconds']);
