...
var SendQueue = [];
const SupportedIndexers = ['*.fanzub.com','*.dognzb.cr','*.nzbs.org','*.nmatrix.co.za','*.oznzb.com','*.binsearch.info','*.binsearch.net','*.nzbgeek.info','*.nzb.su'];
...
function onPrefChange(prefName) {
	nzbgRPC.url = (sp.prefs.nzbg_ssl?'https':'http')+'://'+sp.prefs.nzbg_ip+':'+sp.prefs.nzbg_port+'/'+encodeURIComponent(sp.prefs.nzbg_user)+':'+encodeURIComponent(sp.prefs.nzbg_pass)+'/jsonrpc';
